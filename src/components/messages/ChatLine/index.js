...
class ChatLine extends React.Component {
    render() {
        if (this.props.sender === "friend") {
            return (
                <Row className="chat-line friend d-flex justify-content-start mx-0 mb-5">
                    <Col xs={3}>
                        <Image className="avatar-chat-line" thumbnail roundedCircle src={this.props.avatar} />
                    </Col>
                    <Col xs={9} className="chat-line-text">
            ...
            return (
                <Row className="chat-line owner d-flex justify-content-start mx-0 mb-5">
                    <Col xs={9} className="chat-line-text">
                        <span
                            className="text px-3 py-3"
                            style={{
